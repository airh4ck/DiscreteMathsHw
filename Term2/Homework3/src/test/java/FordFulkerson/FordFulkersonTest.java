...
import CapacityScaling.CapacityScaling;
import Dinitz.Dinitz;
...
class FordFulkersonTest {
	...
	void findMaxFlow() {
		...
		FordFulkerson solver = new FordFulkerson(graph);
	...
	void findMaxFlowBigGraph() {
		...
		FordFulkerson solver = new FordFulkerson(edgeListToAdjacencyList(edges));
